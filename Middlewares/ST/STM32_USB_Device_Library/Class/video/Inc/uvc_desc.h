...
DECLARE_UVC_FRAMES_FORMAT_UNCOMPRESSED(1);
DECLARE_UVC_FRAMES_FORMAT_UNCOMPRESSED(2);

struct uvc_vs_frames_formats_descriptor {
  struct UVC_FRAMES_FORMAT_UNCOMPRESSED(1) uvc_vs_frames_format_1;
  struct UVC_FRAMES_FORMAT_UNCOMPRESSED(2) uvc_vs_frames_format_2;
...
struct usbd_uvc_cfg {
  ...
  struct UVC_EXTENSION_UNIT_DESCRIPTOR(1, 4) uvc_vc_xu_lep_cpu;
...
extern struct usbd_uvc_cfg USBD_UVC_CfgFSDesc_L3;
