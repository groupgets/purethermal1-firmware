...
.uvc_vs_frames_format_1 =
  {
    ...
    .uvc_vs_frame  = { UVC_FRAME_FORMAT(VS_FRAME_INDEX_DEFAULT, YUYV, 160, 120) },
...
.uvc_vs_frames_format_3 =
  {
    ...
    .uvc_vs_frame  = { UVC_FRAME_FORMAT(VS_FRAME_INDEX_DEFAULT, GREY, 160, 120) },
    .uvc_vs_color  = UVC_COLOR_MATCHING_DESCRIPTOR(),
  },
.uvc_vs_frames_format_4 =
  {
    .uvc_vs_format = UVC_FORMAT_UNCOMPRESSED_DESCRIPTOR(RGB565, 1),
    .uvc_vs_frame  = { UVC_FRAME_FORMAT(VS_FRAME_INDEX_DEFAULT, RGB565, 160, 120) },
    .uvc_vs_color  = UVC_COLOR_MATCHING_DESCRIPTOR(),
  },
.uvc_vs_frames_format_5 =
  {
    .uvc_vs_format = UVC_FORMAT_UNCOMPRESSED_DESCRIPTOR(BGR3, 1),
    .uvc_vs_frame  = { UVC_FRAME_FORMAT(VS_FRAME_INDEX_DEFAULT, BGR3, 160, 120) },
    .uvc_vs_color  = UVC_COLOR_MATCHING_DESCRIPTOR(),
  },
},
